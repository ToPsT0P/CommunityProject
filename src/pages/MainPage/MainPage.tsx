    ...
    return (
        <div>
            ...
            <div className="py-5 px-5 gap-10 flex flex-wrap justify-center mb-5">
                <span onClick={() => {dispatch(communityUsersSlice.actions.setPage(page - 1))}} className="p-3 border border-myColor bg-myColor rounded-2xl cursor-pointer text-white hover:shadow-2xl duration-200">Предыдущая</span>
